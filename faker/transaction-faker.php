<?php
    ...
    for ($i = 1; $i <= 200; $i++) {
        ...
        $sql = "INSERT INTO recordsapp.transaction(datelog, documentcode, action, office_id, employee_id, remarks) VALUES ('$datelog','$documentcode','$action','$officeid','$employeeid','$remark')";
